...
class AuthenticatedGraphRequest:
	...
	def invoke_login_dialog(
		...
		token = wait.until(UrlRedirected(self.auth_url))
		# time.sleep(60)
...
auth_graph.invoke_login_dialog()
